...
* 添加网格
*/
define("web3d/node_new/grid",["dojo/topic"],
	function(topic){
		return dojo.declare([],{
			constructor : function(x3d){
                ...
                parent._xmlNode.appendChild(trans);
                 ...
                 * 设置网格大小
                 */
                topic.subscribe("gridHelper/setSize", function(){
                    var child = document.getElementById("grid");
                    if(child){
                        var scale = (Spolo.sceneSize / 16) + "," + (Spolo.sceneSize / 16) + "," + (Spolo.sceneSize / 16);
