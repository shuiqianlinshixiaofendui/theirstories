	...
	return declare("widgets/ModelEdit/ModelEdit", [ WidgetBase, WidgetsInTemplateMixin, TemplatedMixin, Evented ], {
		...
		_changePreview:function(){
			...
			if(label==curLabel){
				...
				this.web3dNode.innerHTML = "<iframe name=\"web3d\" frameborder=\"no\" border=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\" allowtransparency=\"yes\" style=\"width:400px;height:300px\" src=\"/widgets/viewx3d/viewX3D.html?path="+this.path+"\"></iframe> ";
				label = "查看效果图";
			}else{
		...
		_favoriteModel : function(){
			this.modelEditLogic.addFavoriteModel();
		},
		// 模型名称
