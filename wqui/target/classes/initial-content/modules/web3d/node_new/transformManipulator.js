...
define("web3d/node_new/transformManipulator", ["dojo/topic"],function(topic){
	return dojo.declare([],{
		constructor : function(x3d){
            x3dom.nodeTypes.Transform.prototype._min = new x3dom.fields.SFVec3f(0, 0, 0);
            x3dom.nodeTypes.Transform.prototype._max = new x3dom.fields.SFVec3f(0, 0, 0);
            // 包围盒最大最小值
            x3dom.nodeTypes.Transform.prototype.getVolume = function (min, max, invalidate){
            ...
            // 包围盒大小
            x3dom.nodeTypes.Transform.prototype.getBoundingBoxSize = function(){
                var min = new x3dom.fields.SFVec3f(0, 0, 0);
                var max = new x3dom.fields.SFVec3f(0, 0, 0); 
                var valid = this.getVolume(min, max, true);
                var size = new x3dom.fields.SFVec3f(0, 0, 0);
                if(valid){
                    size = this._max.subtract(this._min);
                }
                return size;
            }
			...
			x3dom.nodeTypes.Transform.prototype.replaceDragger = function(name)
			{
				...
				{
					var cthis = this;
					require(["web3d/operate/" + name,"dojo/_base/lang"], function(dragger_class, lang){
