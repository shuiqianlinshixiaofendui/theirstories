...
)
{
		...
		this.modelObj.initData(
			lang.hitch(this,
				function(spnode){
					...
					var colorSystemPath = this.modelObj.getColorSystemPath();
					...
					var res = {
						...
						stylePath: msPath,
                        colorSystem: "请选择色系",
						colorSystemPath: colorSystemPath,
						brand: "请选择品牌",
						brandPath: brandPath,
						madeOf: "请选择主材",
						madeOfPath: mdoPath,
	...
	var defClass = declare("widgets.ModelEdit.ModelEditLogic",[],{
		...
		getModelColorSystem : function(path, callback){
			getFullNameArrayFromFolder(path, callback);
		},
		...
		save : function(json, callback, errorback){
			...
			if(json["colorSystemPath"]!=undefined&&json["colorSystemPath"]!="undefined"){
				this.modelObj.setColorSystemPath(json["colorSystemPath"]);
			};
